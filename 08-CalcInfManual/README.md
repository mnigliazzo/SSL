...
* 16 - Calculadora Infija: Automática — Iteración #1
...
* Implementar el scanner con lex/flex, mantener la interfaz establecida en
Scanner.h
...
Identificar el alcance del parser y del scanner. Utilizar expresiones regulares para definir los tokens, conocer el uso de lex/flex
